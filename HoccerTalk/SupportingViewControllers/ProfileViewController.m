...
- (id) initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self != nil) {
        ...
        mailItem.editLabel = NSLocalizedString(@"MailAddress", @"Profile Edit Label Mail Address");
        mailItem.placeholder = NSLocalizedString(@"Your Mail Address", @"Profile Placeholder MAil Address");
