...
- (id) valueForItem: (DatasheetItem*) item {
    if ([item isEqual: self.chatItem]) {
        ...
        NSFetchRequest *fetchRequest = [AudioAttachmentListViewController fetchRequestForContact:self.contact managedObjectModel:AppDelegate.instance.managedObjectModel];
