...
- (BOOL) isItemVisible:(DatasheetItem *)item {
    NSArray * hidden = @[self.keyItem, self.exportCredentialsItem, self.importCredentialsItem, self.deleteCredentialsFileItem, self.transferCredentialsItem, self.destructiveButton ];
